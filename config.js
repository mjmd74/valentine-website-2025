...
const CONFIG = {
    ...
    colors: {
        backgroundStart: "#C6DEF1",      // Gradient start (try pastel colors for a soft look)
        backgroundEnd: "#C6DEF1",        // Gradient end (should complement backgroundStart)
